        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('DivisionEstudios.coordinador.update') }}">
                            @csrf
                            @foreach($divisionEstudios as $personal)
                                @if($personal->id_role == $divisionRole->id)
                                    <input type="hidden" name="coordinadorActual" value="{{ $personal->id }}">
                                @endif
                            @endforeach
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="coordinador" name="coordinador">
                                        <option value=""  selected>Seleccione coordinador(a) antes de guardar</option>
