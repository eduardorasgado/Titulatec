    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Registro de personal de Departamento de Division de Estudios Profesionales') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('DivisionEstudios.store') }}">
                            @csrf
