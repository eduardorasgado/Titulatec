...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <a class="btn btn-primary" href="/Especialidad">Atrás</a>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                              action="{{ route('Especialidad.update', ['especialidad' => $especialidad->id]) }}"
                                        ...
                                        @if(count($academias) > 0)
                                            @foreach ($academias as $academia)
                                                <option value="{{ $academia->id }}"
                                                    @if($academia->id == $especialidad->id_academia) selected @endif
